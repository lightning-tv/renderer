...
(function () {
  ...
  System.register(['./robot-legacy-qlNob2Ki.js', './utils-legacy-BJnZ2DR0.js'], function (exports, module) {
    'use strict';

    var robotImg, waitForLoadedDimensions;
    return {
      ...
      execute: function execute() {
        ...
        function test(settings) {
          return __async(this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var renderer, testRoot, image, dimensions, dimensionsMatch;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 7;
                  return waitForLoadedDimensions(image);
                case 7:
                  dimensions = _context2.sent;
                  dimensionsMatch = dimensions.width === image.width && dimensions.height === image.height;
...
//# sourceMappingURL=texture-autosize-legacy-D-7Q2-Dm.js.map
