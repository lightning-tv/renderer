        ...
        function animation(_0) {
          return __async(this, arguments, function (_ref) {
            ...
            return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var node, animatableNode, easingLabel, easings, animationIndex, currentAnimation, execEasing;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    animatableNode = renderer.createNode({
                      x: 0,
                      y: 300,
                      width: 200,
                      height: 200,
                    ...
                    easingLabel = renderer.createTextNode({
                      parent: node,
                      x: 40,
                      y: 40,
                      fontFamily: "Ubuntu",
                    ...
                    easings = ["linear", "ease-in", "ease-out", "ease-in-out", "ease-in-sine", "ease-out-sine", "ease-in-out-sine", "ease-in-cubic", "ease-out-cubic", "ease-in-out-cubic", "ease-in-circ", "ease-out-circ", "ease-in-out-circ", "ease-in-back", "ease-out-back", "ease-in-out-back", "cubic-bezier(0,1.35,.99,-0.07)", "cubic-bezier(.41,.91,.99,-0.07)", "loopStopMethodReverse", "loopStopMethodReset", "loop"];
                    animationIndex = 0;
                    execEasing = function execEasing() {
                      var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
                      var _a;
                      var easing = (_a = easings[index]) != null ? _a : "linear";
...
//# sourceMappingURL=animation-legacy-CJrEpO24.js.map
