const __vite__fileDeps=["assets/alpha-blending-DnM7X4ao.js","assets/robot-tJVGEFZ-.js","assets/rocko-DfKMdNEs.js","assets/LocalStorage-CLyIOpmF.js","assets/animation-events-BEwR6T-N.js","assets/clipping-mutations-Bf-UUoVe.js","assets/clipping-C0AzdBYo.js","assets/paginateTestRows-BnRDThRO.js","assets/PageContainer-DGLlaQQn.js","assets/utils-ChpIXmYJ.js","assets/destroy-pw1SU9fS.js","assets/lightning-C5UL5HX9.js","assets/hole-punch-effect-Co2DeQGr.js","assets/elevator-C9Se-LCK.js","assets/inspector-CnWdd9xj.js","assets/resize-mode-BtiQW8Lg.js","assets/robot-CqLLBTI6.js","assets/rtt-dimension-quEDxuOx.js","assets/scaling-CeHMgDj8.js","assets/constructTestRow-BVUPcsU0.js","assets/stress-multi-level-clipping-KMMQ0iCn.js","assets/stress-multi-level-DCzFvvoj.js","assets/stress-multi-texture-a54NYSEA.js","assets/stress-single-level-XLpANAyV.js","assets/test-DYU45i80.js","assets/spritemap-BI6pbO9b.js","assets/text-align-D4Qf86t6.js","assets/LoremIpsum-BORJPcSh.js","assets/text-alpha-DqHxt0Xa.js","assets/text-baseline-BINTUqSr.js","assets/text-contain-BafDOerD.js","assets/text-dimensions-C-8zbPCF.js","assets/text-layout-consistency-modified-metrics-fMy367US.js","assets/text-layout-consistency-BpR8IJCL.js","assets/text-line-height-BBtROEDJ.js","assets/text-max-lines-DrqZC3KX.js","assets/text-offscreen-move-Cvp2mDJB.js","assets/text-overflow-suffix-B-ot9yPm.js","assets/text-rotation-LKEhjt3P.js","assets/text-scaling-jFN7SkKQ.js","assets/text-vertical-align-C08rUUZq.js","assets/text-DwmL2BYz.js","assets/texture-autosize-rPJ4qjhq.js","assets/texture-source-P84IKFON.js","assets/textures-CMW5L4xT.js"],__vite__mapDeps=i=>i.map(i=>__vite__fileDeps[i]);
...
var define_import_meta_env_default = { BASE_URL: "/renderer/", MODE: "production", DEV: false, PROD: true, SSR: false };
...
function isProductionEnvironment() {
  return define_import_meta_env_default && true;
}
let nextId = 1;
function getNewId() {
  return nextId++;
...
const _ImageTexture = class _ImageTexture extends Texture {
  ...
  static makeCacheKey(props) {
    ...
    return `ImageTexture,${key},${(_c = resolvedProps.premultiplyAlpha) != null ? _c : "true"}${dimensionProps}`;
  }
  static resolveDefaults(props) {
...
var __publicField$2 = (obj2, key, value) => __defNormalProp$2(obj2, key + "", value);
class StatTracker {
  constructor() {
...
var __publicField$1 = (obj2, key, value) => __defNormalProp$1(obj2, key + "", value);
class Component {
...
class MemMonitor extends Component {
  constructor(renderer, props) {
    ...
    this.targetInfoText.text = `Target: ${bytesToMb(targetThreshold)} mb (${(targetFraction * 100).toFixed(1)}%)`;
...
Renderable Loaded
- ${bytesToMb(renderableMemUsed)} mb (${(renderableMemoryFraction * 100).toFixed(1)}%)
...
const testModules = /* @__PURE__ */ Object.assign({ "./tests/absolute-position.ts": () => __vitePreload(() => import("./absolute-position--z-2TQLH.js"), true ? [] : void 0), "./tests/alpha-blending.ts": () => __vitePreload(() => import("./alpha-blending-DnM7X4ao.js"), true ? __vite__mapDeps([0,1,2,3]) : void 0), "./tests/alpha.ts": () => __vitePreload(() => import("./alpha-BcdnrnWs.js"), true ? [] : void 0), "./tests/animation-events.ts": () => __vitePreload(() => import("./animation-events-BEwR6T-N.js"), true ? __vite__mapDeps([4,1]) : void 0), "./tests/animation.ts": () => __vitePreload(() => import("./animation-CxE1tJ5Z.js"), true ? [] : void 0), "./tests/child-positioning.ts": () => __vitePreload(() => import("./child-positioning-C7qbDf7U.js"), true ? [] : void 0), "./tests/clipping-mutations.ts": () => __vitePreload(() => import("./clipping-mutations-Bf-UUoVe.js"), true ? __vite__mapDeps([5,1]) : void 0), "./tests/clipping.ts": () => __vitePreload(() => import("./clipping-C0AzdBYo.js"), true ? __vite__mapDeps([6,7,8,3,9,1]) : void 0), "./tests/destroy.ts": () => __vitePreload(() => import("./destroy-pw1SU9fS.js"), true ? __vite__mapDeps([10,11]) : void 0), "./tests/ds-effect-radial-progress.ts": () => __vitePreload(() => import("./ds-effect-radial-progress-B2aLeRzP.js"), true ? [] : void 0), "./tests/dynamic-shader-circle-border-radius.ts": () => __vitePreload(() => import("./dynamic-shader-circle-border-radius-DeMw9-qI.js"), true ? [] : void 0), "./tests/dynamic-shader.ts": () => __vitePreload(() => import("./dynamic-shader-B7nii0Xi.js"), true ? [] : void 0), "./tests/gradient.ts": () => __vitePreload(() => import("./gradient-DlBj35Ac.js"), true ? [] : void 0), "./tests/hole-punch-effect.ts": () => __vitePreload(() => import("./hole-punch-effect-Co2DeQGr.js"), true ? __vite__mapDeps([12,13]) : void 0), "./tests/inspector.ts": () => __vitePreload(() => import("./inspector-CnWdd9xj.js"), true ? __vite__mapDeps([14,11]) : void 0), "./tests/mount-pivot.ts": () => __vitePreload(() => import("./mount-pivot-pPD6gQ-V.js"), true ? [] : void 0), "./tests/no-rtt.ts": () => __vitePreload(() => import("./no-rtt-BJqWVXvj.js"), true ? [] : void 0), "./tests/render-bounds.ts": () => __vitePreload(() => import("./render-bounds-BuYhJ1kp.js"), true ? [] : void 0), "./tests/resize-mode.ts": () => __vitePreload(() => import("./resize-mode-BtiQW8Lg.js"), true ? __vite__mapDeps([15,7,8,3]) : void 0), "./tests/robot.ts": () => __vitePreload(() => import("./robot-CqLLBTI6.js"), true ? __vite__mapDeps([16,1]) : void 0), "./tests/rotation.ts": () => __vitePreload(() => import("./rotation-DlP6jdov.js"), true ? [] : void 0), "./tests/rtt-dimension.ts": () => __vitePreload(() => import("./rtt-dimension-quEDxuOx.js"), true ? __vite__mapDeps([17,2]) : void 0), "./tests/rtt-reflection.ts": () => __vitePreload(() => import("./rtt-reflection-C7fIgx7U.js"), true ? [] : void 0), "./tests/rtt.ts": () => __vitePreload(() => import("./rtt-Dac27op6.js"), true ? [] : void 0), "./tests/scaling-animations.ts": () => __vitePreload(() => import("./scaling-animations-DaNMg9j2.js"), true ? [] : void 0), "./tests/scaling.ts": () => __vitePreload(() => import("./scaling-CeHMgDj8.js"), true ? __vite__mapDeps([18,7,8,3,19,9,1]) : void 0), "./tests/shader-animation.ts": () => __vitePreload(() => import("./shader-animation-BvIRR8zS.js"), true ? [] : void 0), "./tests/stress-multi-level-clipping.ts": () => __vitePreload(() => import("./stress-multi-level-clipping-KMMQ0iCn.js"), true ? __vite__mapDeps([20,1]) : void 0), "./tests/stress-multi-level.ts": () => __vitePreload(() => import("./stress-multi-level-DCzFvvoj.js"), true ? __vite__mapDeps([21,11]) : void 0), "./tests/stress-multi-texture.ts": () => __vitePreload(() => import("./stress-multi-texture-a54NYSEA.js"), true ? __vite__mapDeps([22,11,1]) : void 0), "./tests/stress-single-level-text.ts": () => __vitePreload(() => import("./stress-single-level-text-d7a6qpmV.js"), true ? [] : void 0), "./tests/stress-single-level.ts": () => __vitePreload(() => import("./stress-single-level-XLpANAyV.js"), true ? __vite__mapDeps([23,11]) : void 0), "./tests/test.ts": () => __vitePreload(() => import("./test-DYU45i80.js"), true ? __vite__mapDeps([24,2,13,25]) : void 0), "./tests/text-align.ts": () => __vitePreload(() => import("./text-align-D4Qf86t6.js"), true ? __vite__mapDeps([26,27]) : void 0), "./tests/text-alpha.ts": () => __vitePreload(() => import("./text-alpha-DqHxt0Xa.js"), true ? __vite__mapDeps([28,7,8,3,19,9]) : void 0), "./tests/text-baseline.ts": () => __vitePreload(() => import("./text-baseline-BINTUqSr.js"), true ? __vite__mapDeps([29,7,8,3,9,19]) : void 0), "./tests/text-canvas-font-no-metrics.ts": () => __vitePreload(() => import("./text-canvas-font-no-metrics-CstXv01x.js"), true ? [] : void 0), "./tests/text-canvas.ts": () => __vitePreload(() => import("./text-canvas-CwAy4iIW.js"), true ? [] : void 0), "./tests/text-contain.ts": () => __vitePreload(() => import("./text-contain-BafDOerD.js"), true ? __vite__mapDeps([30,9]) : void 0), "./tests/text-dimensions.ts": () => __vitePreload(() => import("./text-dimensions-C-8zbPCF.js"), true ? __vite__mapDeps([31,9]) : void 0), "./tests/text-events.ts": () => __vitePreload(() => import("./text-events-COOFxEYa.js"), true ? [] : void 0), "./tests/text-layout-consistency-modified-metrics.ts": () => __vitePreload(() => import("./text-layout-consistency-modified-metrics-fMy367US.js"), true ? __vite__mapDeps([32,27]) : void 0), "./tests/text-layout-consistency.ts": () => __vitePreload(() => import("./text-layout-consistency-BpR8IJCL.js"), true ? __vite__mapDeps([33,27]) : void 0), "./tests/text-line-height.ts": () => __vitePreload(() => import("./text-line-height-BBtROEDJ.js"), true ? __vite__mapDeps([34,7,8,3,19,9]) : void 0), "./tests/text-max-lines.ts": () => __vitePreload(() => import("./text-max-lines-DrqZC3KX.js"), true ? __vite__mapDeps([35,7,8,3,19,9,27]) : void 0), "./tests/text-offscreen-move.ts": () => __vitePreload(() => import("./text-offscreen-move-Cvp2mDJB.js"), true ? __vite__mapDeps([36,8,3]) : void 0), "./tests/text-overflow-suffix.ts": () => __vitePreload(() => import("./text-overflow-suffix-B-ot9yPm.js"), true ? __vite__mapDeps([37,7,8,3,19,9,27]) : void 0), "./tests/text-rotation.ts": () => __vitePreload(() => import("./text-rotation-LKEhjt3P.js"), true ? __vite__mapDeps([38,7,8,3,9,19]) : void 0), "./tests/text-scaling.ts": () => __vitePreload(() => import("./text-scaling-jFN7SkKQ.js"), true ? __vite__mapDeps([39,7,8,3,9,19]) : void 0), "./tests/text-ssdf.ts": () => __vitePreload(() => import("./text-ssdf-D9H1Ldec.js"), true ? [] : void 0), "./tests/text-vertical-align.ts": () => __vitePreload(() => import("./text-vertical-align-C08rUUZq.js"), true ? __vite__mapDeps([40,7,8,3,19,9]) : void 0), "./tests/text.ts": () => __vitePreload(() => import("./text-DwmL2BYz.js"), true ? __vite__mapDeps([41,27,3]) : void 0), "./tests/texture-autosize.ts": () => __vitePreload(() => import("./texture-autosize-rPJ4qjhq.js"), true ? __vite__mapDeps([42,1,9]) : void 0), "./tests/texture-cleanup-critical.ts": () => __vitePreload(() => import("./texture-cleanup-critical-BQ_Vb4Db.js"), true ? [] : void 0), "./tests/texture-cleanup-idle.ts": () => __vitePreload(() => import("./texture-cleanup-idle-f1uGzJvK.js"), true ? [] : void 0), "./tests/texture-factory.ts": () => __vitePreload(() => import("./texture-factory-uybS3ecV.js"), true ? [] : void 0), "./tests/texture-source.ts": () => __vitePreload(() => import("./texture-source-P84IKFON.js"), true ? __vite__mapDeps([43,2,11,13]) : void 0), "./tests/texture-svg.ts": () => __vitePreload(() => import("./texture-svg-qCc-y_8F.js"), true ? [] : void 0), "./tests/textures.ts": () => __vitePreload(() => import("./textures-CMW5L4xT.js"), true ? __vite__mapDeps([44,2,13,25]) : void 0), "./tests/tx-compression.ts": () => __vitePreload(() => import("./tx-compression-BsxsALfp.js"), true ? [] : void 0), "./tests/viewport-events-canvas.ts": () => __vitePreload(() => import("./viewport-events-canvas-C8UfsP8w.js"), true ? [] : void 0), "./tests/viewport-events.ts": () => __vitePreload(() => import("./viewport-events-DeomYjS7.js"), true ? [] : void 0), "./tests/zIndex.ts": () => __vitePreload(() => import("./zIndex-BweyI79r.js"), true ? [] : void 0) });
const appWidth = 1920;
...
(async () => {
  ...
  await runAutomation(renderMode, test2, logFps);
})().catch((err) => {
  console.error(err);
});
async function runTest(test2, renderMode, urlParams, showOverlay, showMemMonitor, logicalPixelRatio, physicalPixelRatio, logFps, enableContextSpy, perfMultiplier, enableInspector) {
  const testModule = testModules[getTestPath(test2)];
  if (!testModule) {
    throw new Error(`Test "${test2}" not found`);
  }
...
async function initRenderer(renderMode, logFps, enableContextSpy, logicalPixelRatio, physicalPixelRatio, enableInspector, customSettings) {
  let inspector;
...
async function runAutomation(renderMode, filter3, logFps) {
...
//# sourceMappingURL=index-ClbJRtQD.js.map
