async function absolutePosition({ renderer, testRoot }) {
  function createTextNode(container, label) {
    const textNode = renderer.createTextNode({
      x: 10,
      y: 10,
      text: `${label ? label + "\n" : ""}X: ${container.x} => absX: ${container.absX}
Y: ${container.y} => absY: ${container.absY}
MountX: ${container.mountX} | MountY: ${container.mountY}`,
      parent: container
    });
    return textNode;
  }
...
//# sourceMappingURL=absolute-position--z-2TQLH.js.map
