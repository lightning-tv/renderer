      ...
      execute: function execute() {
        ...
        function test(settings) {
          return __async(this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var renderer, testRoot, nodes, renderNode, spawn, despawn, move, newColor, animating, animate;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  renderer = settings.renderer, testRoot = settings.testRoot;
                  nodes = [];
                  renderNode = function renderNode(t) {
                    var node = renderer.createTextNode({
                      x: Math.random() * 1900,
                      y: Math.random() * 1080,
                      text: "CANVAS " + t,
                  ...
                  animate = function animate() {
                    animating = !animating;
                    var animateNode = function animateNode(node) {
                    ...
                    var _animateRun = function animateRun() {
                      if (animating) {
                        for (var i = 0; i < nodes.length; i++) {
                          animateNode();
                        }
                        setTimeout(_animateRun, 3050);
                      }
                    };
                    _animateRun();
                  };
...
//# sourceMappingURL=text-canvas-legacy-DmHNc46G.js.map
