...
(function () {
  ...
  System.register(['./paginateTestRows-legacy-D7LGldus.js', './PageContainer-legacy-DU5UrY0o.js', './index-legacy-D-N-k8NI.js', './LocalStorage-legacy-DdztG2dl.js'], function (exports, module) {
    'use strict';

    var paginateTestRows, PageContainer, deg2Rad;
    return {
      ...
      execute: function execute() {
        ...
        var testscreenImg = "/renderer/assets/testscreen-B6KykUZE.png";
        var testscreenRImg = "/renderer/assets/testscreen_rotated-fXg0gRdD.png";
          ...
          return __async(this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
            ...
            return _regeneratorRuntime().wrap(function _callee10$(_context10) {
              while (1) switch (_context10.prev = _context10.next) {
                  ...
                  return paginateTestRows(pageContainer, [{
                        ...
                        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                          while (1) switch (_context2.prev = _context2.next) {
                            case 0:
                              ...
                              return _context2.abrupt("return", rowNode.height);
                            case 4:
                            case "end":
                        ...
                        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                          while (1) switch (_context3.prev = _context3.next) {
                            case 0:
                              ...
                              return _context3.abrupt("return", rowNode.height);
                            case 4:
                            case "end":
                        ...
                        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
                          while (1) switch (_context4.prev = _context4.next) {
                            case 0:
                              ...
                              rowNode.height = SQUARE_SIZE - 300;
                              return _context4.abrupt("return", rowNode.height);
                            case 4:
                            case "end":
                        ...
                        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
                          while (1) switch (_context5.prev = _context5.next) {
                            case 0:
                              ...
                              rowNode.height = SQUARE_SIZE - 200;
                              return _context5.abrupt("return", rowNode.height);
                            case 4:
                            case "end":
                    ...
                    content: function content(rowNode) {
                      return __async(_this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
                        var curX, containerProps, textureNodeProps, container1;
                        return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                          while (1) switch (_context6.prev = _context6.next) {
                            case 0:
                              ...
                              container1 = renderer.createNode(__spreadProps(__spreadValues({}, containerProps), {
                                x: curX
                              }));
                              ...
                              return _context6.abrupt("return", rowNode.height);
                            case 8:
                            case "end":
                        ...
                        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
                          while (1) switch (_context7.prev = _context7.next) {
                            case 0:
                              ...
                              rowNode.height = containerProps.height;
                              return _context7.abrupt("return", rowNode.height);
                            case 7:
                            case "end":
                    ...
                    content: function content(rowNode) {
                      return __async(_this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee8() {
                        var curX, containerProps, textureNodeProps, container1, container2;
                        return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                          while (1) switch (_context8.prev = _context8.next) {
                            case 0:
                              ...
                              rowNode.height = containerProps.height;
                              return _context8.abrupt("return", rowNode.height);
                            case 10:
                            case "end":
                    ...
                    title: "Texture Width < Height - resizeMode contain maximum height of node",
                    content: function content(rowNode) {
                      return __async(_this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee9() {
                        var curX, containerProps, textureNodeProps, container1, container2;
                        return _regeneratorRuntime().wrap(function _callee9$(_context9) {
                          while (1) switch (_context9.prev = _context9.next) {
                            case 0:
                              ...
                              rowNode.height = containerProps.height;
                              return _context9.abrupt("return", rowNode.height);
                            case 10:
                            case "end":
                ...
                case 4:
                  return _context10.abrupt("return", pageContainer);
                case 5:
                case "end":
...
//# sourceMappingURL=resize-mode-legacy-CucDMV0N.js.map
