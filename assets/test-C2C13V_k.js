...
import { a as assertTruthy } from "./index-CRSMeQPo.js";
  ...
  return __async(this, arguments, function* ({ renderer, testRoot }) {
    ...
    setTimeout(() => __async(this, null, function* () {
      while (true) {
        ...
        yield rockoAnimation.waitUntilStopped();
    ...
    setTimeout(() => __async(this, null, function* () {
      while (true) {
        ...
        yield elevatorAnimation.waitUntilStopped();
        elevatorAnimation = elevatorRect.animate(
          {
            // y: 1080 - elevatorRect.height,
          },
...
//# sourceMappingURL=test-C2C13V_k.js.map
