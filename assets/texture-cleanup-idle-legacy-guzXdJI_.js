        ...
        function textureCleanupIdle(_0) {
          return __async(this, arguments, function (_ref) {
            ...
            return /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var screenWidth, screenHeight, gridWidth, gridHeight, nodeWidth, nodeHeight, curNodes, i, j, node, _i, _curNodes, _node;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    ...
                    screenWidth = renderer.settings.appWidth;
                    screenHeight = renderer.settings.appHeight;
                    gridWidth = 4;
                    gridHeight = 2;
                    nodeWidth = screenWidth / gridWidth;
                    nodeHeight = screenHeight / gridHeight;
                  case 8:
                    if (!true) {
                      _context.next = 16;
                      break;
                    ...
                    return delay(1e3);
                  case 13:
                    for (_i = 0, _curNodes = curNodes; _i < _curNodes.length; _i++) {
                      _node = _curNodes[_i];
                      _node.x = -screenWidth * 2;
                      _node.y = -screenHeight * 2;
                      _node.on("freed", function (thisNode) {
                        thisNode.destroy();
                      });
                    }
                    _context.next = 8;
...
//# sourceMappingURL=texture-cleanup-idle-legacy-guzXdJI_.js.map
