...
(function () {
  ...
  System.register(['./paginateTestRows-legacy-DpUfmeYm.js', './PageContainer-legacy-JznUlj8g.js', './constructTestRow-legacy-C8-7LPX4.js', './robot-legacy-qlNob2Ki.js', './index-legacy-_bqSIRai.js', './LocalStorage-legacy-DdztG2dl.js', './utils-legacy-BJnZ2DR0.js'], function (exports, module) {
    'use strict';

    var paginateTestRows, PageContainer, constructTestRow, robotImg;
    return {
              ...
              while (1) switch (_context11.prev = _context11.next) {
                case 0:
                  ...
                  return paginateTestRows(pageContainer, [{
                          ...
                          while (1) switch (_context2.prev = _context2.next) {
                            case 0:
                              ...
                              return constructTestRow({
                                renderer: renderer,
                                rowNode: rowNode
                              }, [renderer.createNode(__spreadValues({}, nodeProps)), "scale 2 ->\npivot 0.5 ->", renderer.createNode(__spreadProps(__spreadValues({}, nodeProps), {
                                scale: 2
                                // pivot: 0.5, (should be default)
                              })), "pivot 0 ->", renderer.createNode(__spreadProps(__spreadValues({}, nodeProps), {
                                pivot: 0,
                                scale: 2
                              })), "pivot 1 ->", renderer.createNode(__spreadProps(__spreadValues({}, nodeProps), {
                                pivot: 1,
                                scale: 2
                              }))]);
                            case 3:
                    ...
                    content: function content(rowNode) {
                      return __async(_this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee10() {
                        var nodeProps;
                ...
                case 4:
                  return _context11.abrupt("return", pageContainer);
                case 5:
                case "end":
...
//# sourceMappingURL=scaling-legacy-DgcTsW4d.js.map
