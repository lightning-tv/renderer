...
(function () {
  ...
  System.register(['./index-legacy-qyIsAgiU.js'], function (exports, module) {
    'use strict';
      ...
      execute: function execute() {
        ...
        function createPageConstructor(curPageRowConstructors) {
          return function (rowConstructors, pageNode) {
            return __async(this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
              var curY, _iterator, _step, rowConstructor, rowNode;
              return _regeneratorRuntime().wrap(function _callee$(_context) {
                while (1) switch (_context.prev = _context.next) {
                  case 0:
                    curY = 0;
                    _iterator = _createForOfIteratorHelper(rowConstructors);
                    _context.prev = 2;
                    _iterator.s();
                  case 4:
                    ...
                    rowConstructor = _step.value;
                    _context.next = 8;
                    return rowConstructor(pageNode);
                  case 8:
                    rowNode = _context.sent;
                    rowNode.y = curY;
                    curY += rowNode.height;
                  case 11:
                    _context.next = 4;
        ...
        function paginateTestRows(pageContainer, testRows) {
          return __async(this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var _this = this;
            var renderer, pageCurY, curPageRowConstructors, curRowIndex, _iterator2, _step2, _loop;
            return _regeneratorRuntime().wrap(function _callee3$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  renderer = pageContainer.renderer;
                  assertTruthy(renderer.root);
                  pageCurY = 0;
                  curPageRowConstructors = [];
                  curRowIndex = 0;
                  _iterator2 = _createForOfIteratorHelper(testRows);
                  _context4.prev = 6;
                  _loop = /*#__PURE__*/_regeneratorRuntime().mark(function _loop() {
                    var testRow, isLastRow, newRowConstructor, itFits, tmpRowContainer, pageConstructor, pageConstructor2;
                    return _regeneratorRuntime().wrap(function _loop$(_context3) {
                      while (1) switch (_context3.prev = _context3.next) {
                        case 0:
                          testRow = _step2.value;
                          isLastRow = curRowIndex === testRows.length - 1;
                          newRowConstructor = testRow && function (pageNode) {
                            return __async(_this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
                              var rowContainer, rowHeaderNode, rowNode, rowHeight;
                              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                                while (1) switch (_context2.prev = _context2.next) {
                                  case 0:
                                    assertTruthy(testRow);
                                    rowContainer = renderer.createNode({
                                      x: 0,
                                      y: pageCurY,
                                    ...
                                    rowHeaderNode = renderer.createTextNode({
                                      fontFamily: "Ubuntu",
                                      fontSize: HEADER_FONT_SIZE,
                                      y: PADDING,
                                      parent: rowContainer
                                    });
                                    rowNode = renderer.createNode({
                          ...
                          _context3.next = 7;
                          return newRowConstructor(renderer.root);
                        case 7:
                          tmpRowContainer = _context3.sent;
                        ...
                        case 10:
                          if (!itFits || isLastRow) {
                            pageConstructor = createPageConstructor(curPageRowConstructors);
                            ...
                            if (isLastRow && !itFits && curPageRowConstructors.length > 0) {
                              pageConstructor2 = createPageConstructor(curPageRowConstructors);
...
//# sourceMappingURL=paginateTestRows-legacy-CLe-L7TJ.js.map
