        ...
        function test(_0) {
          return __async(this, arguments, function (_ref) {
            ...
            return /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              var randomColor, rnd, FONT_SIZE, execTest;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    execTest = function _execTest(y, title, setKey) {
                      ...
                      return new Promise(function (resolve, reject) {
                        setTimeout(function () {
                          ...
                          if (result === "Pass") resolve(true);else reject({
                            setKey: setKey,
                    ...
                    randomColor = function randomColor() {
                      var randomInt = Math.floor(Math.random() * Math.pow(2, 32));
                      var hexString = randomInt.toString(16).padStart(8, "0");
                    ...
                    _context2.next = 7;
                    return execTest(80, "1 - No key", false);
                  case 7:
                    _context2.next = 9;
                    return execTest(400, "2 - With key", true);
                  case 9:
                  case "end":
...
//# sourceMappingURL=texture-factory-legacy-DXDnGGmk.js.map
