...
(function () {
  ...
  System.register(['./utils-legacy-BJnZ2DR0.js'], function (exports, module) {
    'use strict';

    var waitForLoadedDimensions;
    return {
      ...
      execute: function execute() {
        ...
        function test(settings) {
          return __async(this, null, /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var renderer, testRoot, textSizeAfterLoadingBg, textReportedSizeBg, text1, indexInfo, textSizeAfterLoadInfo, textReportedSizeInfo, textSetDimsInfo, header, i, mutations, next;
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
                        ...
                        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                          while (1) switch (_context2.prev = _context2.next) {
                            ...
                            case 4:
                              ...
                              header.text = makeHeader(text1.textRendererOverride, text1.contain, text1.width, text1.height);
                              indexInfo.text = (i + 1).toString();
                              textSetDimsInfo.text = "Set size: ".concat(Math.round(text1.width), "x").concat(Math.round(text1.height));
                              _context2.next = 11;
                              return waitForLoadedDimensions(text1);
                            case 11:
                              dimensions = _context2.sent;
                              textSizeAfterLoadingBg.width = text1.width;
                              textSizeAfterLoadingBg.height = text1.height;
                              textSizeAfterLoadInfo.text = "After 'loading' size: ".concat(Math.round(textSizeAfterLoadingBg.width), "x").concat(Math.round(textSizeAfterLoadingBg.height));
                              textReportedSizeBg.width = dimensions.width;
                              textReportedSizeBg.height = dimensions.height;
                              textReportedSizeInfo.text = "'loading' event size: ".concat(Math.round(textReportedSizeBg.width), "x").concat(Math.round(textReportedSizeBg.height));
                  ...
                  textSizeAfterLoadingBg = renderer.createNode({
                    x: 5,
                    y: 5,
                    width: 0,
                    height: 0,
                  ...
                  textReportedSizeBg = renderer.createNode({
                  ...
                  textSizeAfterLoadInfo = renderer.createTextNode({
                    x: testRoot.width,
                  ...
                  textReportedSizeInfo = renderer.createTextNode({
                    x: testRoot.width,
                  ...
                  textSetDimsInfo = renderer.createTextNode({
                    x: testRoot.width,
                  ...
                  header = renderer.createTextNode({
                    x: testRoot.width,
...
//# sourceMappingURL=text-contain-legacy-DTw_1t7I.js.map
