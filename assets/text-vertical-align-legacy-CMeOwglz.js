  ...
  System.register(['./paginateTestRows-legacy-CcFkN19Y.js', './PageContainer-legacy-CmmQ12yr.js', './constructTestRow-legacy-C8-7LPX4.js', './index-legacy-B71_XFT2.js', './LocalStorage-legacy-DdztG2dl.js', './utils-legacy-BJnZ2DR0.js'], function (exports, module) {
    ...
    return {
      ...
      execute: function execute() {
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  _context2.next = 4;
                  return paginateTestRows(pageContainer, [].concat(_toConsumableArray(generateVerticalAlignTest(renderer, "sdf")), [null], _toConsumableArray(generateVerticalAlignTest(renderer, "canvas"))));
                case 4:
        ...
        var CONTAINER_SIZE = 200;
        function getSquare(renderer, node) {
          var wrapper = renderer.createNode({
            width: CONTAINER_SIZE,
            height: CONTAINER_SIZE
          });
          var line1 = renderer.createNode({
            width: CONTAINER_SIZE,
            height: 1,
            color: 16711935,
                  ...
                  while (1) switch (_context3.prev = _context3.next) {
                    case 0:
                      ...
                      return constructTestRow({
                        renderer: renderer,
                        rowNode: rowNode
                      }, ["verticalAlign: middle\n(default)\n->", getSquare(renderer, baselineNode), "top ->", getSquare(renderer, renderer.createTextNode(__spreadProps(__spreadValues({}, nodeProps), {
                        verticalAlign: "top"
                      }))), "bottom ->", getSquare(renderer, renderer.createTextNode(__spreadProps(__spreadValues({}, nodeProps), {
...
//# sourceMappingURL=text-vertical-align-legacy-CMeOwglz.js.map
