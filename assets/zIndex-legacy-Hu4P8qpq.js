        ...
        function test(_0) {
          return __async(this, arguments, function (_ref) {
            ...
            return /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
              var generatedRectangles, parentRect;
              return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                while (1) switch (_context2.prev = _context2.next) {
                  case 0:
                    ...
                    generatedRectangles = [];
                    Array(10).fill(null).forEach(function (_, i) {
                      var color = Object.keys(Colors)[i % Object.keys(Colors).length];
                      generatedRectangles.push(renderer.createNode({
                        x: 200 + i * 20,
                        y: 200 + i * 20,
                        width: 200,
                        height: 200,
                    ...
                    parentRect = renderer.createNode({
                      x: 800,
                      y: 200,
                      width: 600,
                      height: 600,
                    ...
                    window.addEventListener("keydown", function (e) {
                      if (e.code === "ArrowLeft") {
                        generatedRectangles.forEach(function (rect) {
                    ...
                    renderer.createNode({
                      ...
                      // @ts-expect-error Invalid prop test
                      // eslint-disable-next-line  @typescript-eslint/no-empty-function
                      zIndexLocked: function zIndexLocked() {},
                      parent: testRoot
                    });
                    renderer.createNode({
                      x: 500,
...
//# sourceMappingURL=zIndex-legacy-Hu4P8qpq.js.map
